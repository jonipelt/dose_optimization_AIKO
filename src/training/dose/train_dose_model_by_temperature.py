...
METRICS_OUTPUT_PATH = "models/metrics/metrics_dose_temp.csv"  # Change if needed
...
def train_model_for_temp_class(temp_class, df_sub):
    print(f"\nTraining dose model for temperature class: {temp_class} ({len(df_sub)} rows)")
    ...
    model_filename = f"dose_model_temp_{temp_class}.pkl"
